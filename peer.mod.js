...
function Peer(id, options) {
  ...
  if (!util.supports.audioVideo && !util.supports.data ) {
    this._delayedAbort('browser-incompatible', 'The current browser does not support WebRTC'); //xnohat: browser compatible
    return;
  }
...
//var defaultConfig = {"iceServers":[{"urls":["turns:stun.cybertizen.com:5349?transport=tcp"],"username":"stunuser","credential":"stunpublicserverpwd"}],"iceTransportPolicy":"all","iceCandidatePoolSize":"0"};
//var defaultConfig = {"iceServers":[{"urls":"turn:m1.xirsys.com:3478?transport=udp","username":"3f581ab8-047f-11e8-ae67-a6b003167623","credential":"3f581b62-047f-11e8-9ad9-40c86f66db19"}]};
var defaultConfig = {"iceServers":[{"urls":"turn:turn.cybertizen.com:3478?transport=udp","username":"turnserver","credential":"JUXSPCHeOiwAWBKzyLbJ"}]};
var dataCount = 1;
...
var util = {
  ...
  supports: (function() {
    ...
    if (data) {
      ...
      //var reliablePC = new RTCPeerConnection(null, {});
      try {
    ...
    if (!onnegotiationneeded && data) {
      ...
      //var negotiationPC = new RTCPeerConnection(null);
